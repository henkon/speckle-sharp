      ...
      foreach (var areaName in areaNames)
      {
        ...
        for (int i = 0; i < numberOfForceResults; i++)
        {
          results.Add(new Result2D
          {
            ...
            stressTopYZ = (float)S23Avg[i], // SAP2000 reports avg out-of-plane shear
            stressTopZX = (float)S12Top[i],
            stressMidXX = 0, // SAP2000 does not report
            stressMidYY = 0, // SAP2000 does not report
            stressMidZZ = 0, // SAP2000 does not report
            stressMidXY = 0, // SAP2000 does not report
            stressMidYZ = 0, // SAP2000 does not report
            stressMidZX = 0, // SAP2000 does not report
            ...
            stressBotYZ = (float)S23Avg[i], // SAP2000 reports avg out-of-plane shear
