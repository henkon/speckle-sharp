...
//using OSEA = Objects.Structural.SAP2000.Analysis;
using Objects.Converter.SAP2000;
using Speckle.Core.Logging;
using Objects.Structural.Analysis;
using Objects.Structural.Results;
//using Objects.Structural.SAP2000.Geometry;
...
namespace Objects.Converter.SAP2000
{
  public partial class ConverterSAP2000 : ISpeckleConverter
  {
...
#endif
    public string Description => "Default Speckle Kit for SAP2000";

    public string Name => nameof(ConverterSAP2000);
    ...
    {
      foreach (var type in Enum.GetNames(typeof(ConverterSAP2000.SAP2000ConverterSupported)))
      {
    ...
    {
      foreach (var type in Enum.GetNames(typeof(ConverterSAP2000.SAP2000APIUsableTypes)))
      {
    ...
    public Base ConvertToSpeckle(object @object)
    {
      ...
      switch (type)
      {
        ...
        //  break;
        //case "Tendon":
        //  returnObject = SAP2000TendonToSpeckle(name);
    ...
    public IEnumerable<string> GetServicedApplications() => new string[] { SAP2000AppName };
